...
if __name__=='__main__':
    ...
    parser.add_argument('--audiofilelist', type=str,   help='Location for scp file with audio locations',  default = '/public/home/qinxy/jarend/SkipConvNet/kaiduan1_beamforming.scp')
    ...
    # 使用 tqdm 替换 pkbar
    for (audioName, locations) in tqdm(audiofilelist.items(), desc='Decoding AudioFiles'):
